...
import msteamsnotifications.teamcity.MsTeamsNotificationFactory;
import msteamsnotifications.teamcity.MsTeamsNotificationFactoryImpl;
...
public class MsTeamsNotificationTest {
	...
	MsTeamsNotificationFactory factory = new MsTeamsNotificationFactoryImpl();
	...
	public void test_ProxyPort() {
		MsTeamsNotification W = factory.getMsTeamsNotification(proxy, proxyPort);
	...
	public void test_FileNotFoundExeption() throws FileNotFoundException, IOException{
		...
		MsTeamsNotification w = factory.getMsTeamsNotification(proxy, proxyPort);
		w.setFilename("MsTeamsNotifications/src/test/resources/fileWithDoesNotExist.txt");
		w.setEnabled(true);
		w.post();
	...
	public void test_IOExeption() throws IOException{
		...
		MsTeamsNotification w = factory.getMsTeamsNotification("localhost", proxyPort);
		w.setEnabled(true);
		w.post();
		System.out.print(".. done");
	}
    ...
    public void actualTest() throws IOException {
        MsTeamsNotificationImpl impl = new MsTeamsNotificationImpl();
...
/*
	...
	public void test_200() throws FileNotFoundException, IOException, Exception {
		...
		MsTeamsNotification w = factory.getMsTeamsNotification(httpClient, "#test-channel");
		w.setEnabled(true);
		w.post();
	...
	public void test_NotEnabled() throws FileNotFoundException, IOException, InterruptedException {
		MsTeamsNotificationTestServer s = startWebServer();
		MsTeamsNotification w = factory.getMsTeamsNotification(url + "/200", proxy, proxyPort);
		w.post();
		stopWebServer(s);
	...
	public void test_200WithProxy() throws FileNotFoundException, IOException, InterruptedException {
		MsTeamsNotificationTestServer s = startWebServer();
		MsTeamsNotificationTestProxyServer p = startProxyServer();
		MsTeamsNotification w = factory.getMsTeamsNotification(url + "/200", proxy, proxyPort);
		w.setEnabled(true);
		w.post();
		stopWebServer(s);
	...
	public void test_200WithProxyFailAuth() throws FileNotFoundException, IOException, InterruptedException {
		MsTeamsNotificationTestServer s = startWebServer();
		MsTeamsNotificationTestProxyServer p = startProxyServerAuth(proxyUsername, proxyPassword);
		MsTeamsNotification w = factory.getMsTeamsNotification(url + "/200", proxy, proxyPort);
		w.setEnabled(true);
		w.post();
		stopWebServer(s);
	...
	public void test_200WithFilename() throws FileNotFoundException, IOException, Exception {
		MsTeamsNotificationTestServer s = startWebServer();
		MsTeamsNotification w = factory.getMsTeamsNotification(url + "/200");
	...
	public void test_302() throws FileNotFoundException, IOException, Exception {
		MsTeamsNotificationTestServer s = startWebServer();
		MsTeamsNotification w = factory.getMsTeamsNotification(url + "/302");
		w.setEnabled(true);
		w.post();
		stopWebServer(s);
	...
	public void test_302WithProxy() throws FileNotFoundException, IOException, InterruptedException {
		MsTeamsNotificationTestServer s = startWebServer();
		MsTeamsNotificationTestProxyServer p = startProxyServer();
		MsTeamsNotification w = factory.getMsTeamsNotification(url + "/302", proxy, proxyPort);
		w.setEnabled(true);
		w.post();
		stopWebServer(s);
		stopProxyServer(p);
	...
	public void test_404WithProxyStringPort() throws FileNotFoundException, IOException, InterruptedException {
		MsTeamsNotificationTestServer s = startWebServer();
		MsTeamsNotificationTestProxyServer p = startProxyServer();
		MsTeamsNotification w = factory.getMsTeamsNotification(url + "/404", proxy, proxyPortString);
		w.setEnabled(true);
		w.post();
		stopWebServer(s);		
		stopProxyServer(p);
	...
	public void test_404WithProxyConfig() throws FileNotFoundException, IOException, InterruptedException {
		MsTeamsNotificationTestServer s = startWebServer();
		MsTeamsNotificationTestProxyServer p = startProxyServer();
		MsTeamsNotificationProxyConfig pc = new MsTeamsNotificationProxyConfig(proxy, Integer.parseInt(proxyPortString));
		MsTeamsNotification w = factory.getMsTeamsNotification(url + "/404", pc);
		w.setEnabled(true);
		w.post();
		stopWebServer(s);
		stopProxyServer(p);
	...
	@Ignore
	public void test_MsTeamsNotificationCollection() throws MsTeamsNotificationParameterReferenceException {
		Map <String, String> params = new HashMap<String, String>();
		params.put("system.msteamsnotifications.1.url", url);
		params.put("system.msteamsnotifications.1.enabled", "true");
		params.put("system.msteamsnotifications.1.parameter.1.name","fod");
		params.put("system.msteamsnotifications.1.parameter.1.value","baa");
		params.put("system.msteamsnotifications.1.parameter.2.name","slash");
		params.put("system.msteamsnotifications.1.parameter.2.value","dot");
		params.put("system.msteamsnotifications.2.url", url + "/something");
		params.put("system.msteamsnotifications.2.enabled", "false");
		params.put("system.msteamsnotifications.2.parameter.1.name","foo");
		params.put("system.msteamsnotifications.2.parameter.1.value","bar");
		MsTeamsNotificationCollection whc = new MsTeamsNotificationCollection(params);
		System.out.println("Test 1" + whc.getMsTeamsNotifications().get(1).getParameterisedUrl());
		System.out.println("Test 2" + whc.getMsTeamsNotifications().get(2).getParameterisedUrl());
		assertTrue(whc.getMsTeamsNotifications().get(1).getChannel().equals(url));
		assertTrue((whc.getMsTeamsNotifications().get(1).getParameterisedUrl().equals(url + "?fod=baa&slash=dot"))
				|| (whc.getMsTeamsNotifications().get(1).getParameterisedUrl().equals(url + "?slash=dot&fod=baa")));
		assertTrue(whc.getMsTeamsNotifications().get(2).getParameterisedUrl().equals(url + "/something?foo=bar"));
		assertFalse(whc.getMsTeamsNotifications().get(1).isErrored());
	}
	
	@Ignore
	public void test_MsTeamsNotificationCollectionWithRecursiveParameterReference() throws MsTeamsNotificationParameterReferenceException {
		Map <String, String> params = new HashMap<String, String>();
		params.put("system.test.recursive1", "%system.test.recursive2%");
		params.put("system.test.recursive2", "blahblah");
		params.put("system.msteamsnotifications.1.url", url);
		params.put("system.msteamsnotifications.1.enabled", "true");
		params.put("system.msteamsnotifications.1.parameter.1.name","foo");
		params.put("system.msteamsnotifications.1.parameter.1.value","bar");
		params.put("system.msteamsnotifications.1.parameter.2.name","slash");
		params.put("system.msteamsnotifications.1.parameter.2.value","%system.test.recursive1%");
		MsTeamsNotificationCollection whc = new MsTeamsNotificationCollection(params);
		System.out.println("Test 1" + whc.getMsTeamsNotifications().get(1).getParameterisedUrl());
		assertTrue(whc.getMsTeamsNotifications().get(1).getChannel().equals(url));
		assertTrue((whc.getMsTeamsNotifications().get(1).getParameterisedUrl().equals(url + "?foo=bar&slash=blahblah"))
				|| (whc.getMsTeamsNotifications().get(1).getParameterisedUrl().equals(url + "?slash=blahblah&foo=bar")));
		assertFalse(whc.getMsTeamsNotifications().get(1).isErrored());
	}

	@Ignore
	public void test_MsTeamsNotificationCollectionWithNonExistantRecursiveParameterReference(){
		Map <String, String> params = new HashMap<String, String>();
		...
		System.out.println("Test 1" + whc.getMsTeamsNotifications().get(1).getParameterisedUrl());
		assertTrue(whc.getMsTeamsNotifications().get(1).getChannel().equals(url));
		assertTrue(whc.getMsTeamsNotifications().get(1).getParameterisedUrl().equals(url + "?foo=bar"));
		assertTrue(whc.getMsTeamsNotifications().get(1).isErrored());
		System.out.println(whc.getMsTeamsNotifications().get(1).getErrorReason());
	}

    public void test_MsTeamsNotificationCollectionWithPost() throws MsTeamsNotificationParameterReferenceException, InterruptedException {
		Map <String, String> params = new HashMap<String, String>();
		//params.put("system.msteamsnotifications.1.url", url + "/200");
		params.put("system.msteamsnotifications.1.url", "http://localhost/msteamsnotifications/" );
		params.put("system.msteamsnotifications.1.enabled", "true");
		params.put("system.msteamsnotifications.1.parameter.1.name","fod");
		params.put("system.msteamsnotifications.1.parameter.1.value","baa");
		params.put("system.msteamsnotifications.1.parameter.2.name","slash");
		params.put("system.msteamsnotifications.1.parameter.2.value","dot");
		params.put("system.msteamsnotifications.2.url", "http://localhost/msteamsnotifications/test/" );
		params.put("system.msteamsnotifications.2.enabled", "true");
		MsTeamsNotificationCollection whc = new MsTeamsNotificationCollection(params);
		MsTeamsNotificationTestServer s = startWebServer();
		for (Iterator<MsTeamsNotification> i = whc.getMsTeamsNotificationsAsCollection().iterator(); i.hasNext();){
			MsTeamsNotification wh = i.next();
			try {
					wh.post();					
		...
		stopWebServer(s);
		assertTrue(whc.getMsTeamsNotifications().get(1).getStatus() == HttpStatus.SC_OK);
		assertTrue(whc.getMsTeamsNotifications().get(2).getStatus() == HttpStatus.SC_NOT_FOUND);
	}
	*/
	public MsTeamsNotificationTestServer startWebServer(){
		try {
			MsTeamsNotificationTestServer s = new MsTeamsNotificationTestServer(webserverHost, webserverPort);
			s.server.start();
			return s;
		} catch (Exception e) {
			e.printStackTrace();
	...
	public void stopWebServer(MsTeamsNotificationTestServer s) throws InterruptedException {
		try {
			s.server.stop();
	...
	public MsTeamsNotificationTestProxyServer startProxyServer(){
		try {
			MsTeamsNotificationTestProxyServer p = new MsTeamsNotificationTestProxyServer(webserverHost, proxyserverPort);
			p.server.start();
			return p;
		} catch (Exception e) {
			e.printStackTrace();
	...
	public MsTeamsNotificationTestProxyServer startProxyServerAuth(String username, String password){
		try {
			MsTeamsNotificationTestProxyServer p = new MsTeamsNotificationTestProxyServer(webserverHost, proxyserverPort,
					username, password);
			p.server.start();
	...
	public void stopProxyServer(MsTeamsNotificationTestProxyServer p) {
		try {
			p.server.stop();
			// Sleep to let the server shutdown cleanly.
			Thread.sleep(1000);
